    ...
    zh: {
        translation: {
            ...
            "sections": {
                ...
                "valuesSub_plm": "深耕工业数字化，在大型制造业PLM落地、架构设计能力突出",
                "valuesSub_geek": "聚焦技术底层创新、大模型应用探索与全栈架构的极客能力体系",
                "products": "AI 产品与技术探索",
    ...
    en: {
        translation: {
            ...
            "hero": {
                ...
                "team": "Agile Team Managed",
            },
            "sections": {
                "values": "Core Competencies",
                "valuesSub": "Full-stack support across presales, architecture, and team management.",
                "valuesSub_plm": "Comprehensive capabilities in enterprise PLM implementation, architecture design.",
                "valuesSub_geek": "A geek competency system focused on deep-tech innovation, LLM application exploration, and full-stack architecture.",
