...
export const MediaPlayer = ({ videos, pdfs, image, github, weblink, initialMediaType = 'video' }: MediaPlayerProps) => {
                    ...
                    <>
                        {videos.map((video, index) => (
                            <button
                                ...
                                className={`inline-flex items-center gap-2 px-4 py-2 border rounded-full text-sm font-medium transition-all ${selectedVideo === video.url && !selectedPdf
                    ...
                    <>
                        {pdfs.map((pdf, index) => (
                            <button
                                ...
                                className={`inline-flex items-center gap-2 px-4 py-2 border rounded-full text-sm font-medium transition-all ${selectedPdf === pdf.url
                                        ? 'bg-accent text-white border-accent'
                                        : 'border-border hover:bg-accent/5 hover:text-accent hover:border-accent/30'
                                    }`}
                            >
