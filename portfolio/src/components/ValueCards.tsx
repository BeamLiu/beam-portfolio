...
const values = [
    {
        ...
        title: "顶配制造业老兵",
        desc: "从 PLM 到 MOM/MES 再到 IIoT，深谙工厂痛点与业务。"
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: "AI 与大模型落地先锋",
        desc: "Google ML/DL 认证，探索生成式 AI 工业赋能与架构验证。"
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: "卓越售前与商业转化",
        desc: "西门子 IIoT 售前认证，擅长建立信任，千万级关键订单破局。"
    },
    {
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: "敏捷布道与梯队管理",
        desc: "微服务先驱，崇尚 DX (开发者体验)，打造高效的 70+ 人战斗力团队。"
    }
];
